...
public class DeleteLead {
	...
	public static void main(String[] args) {
		...
		String Leadid = driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a[text()='15123']")).getText();
		System.out.println("First Lead id: " +Leadid);
		driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a[text()='15123']")).click();
