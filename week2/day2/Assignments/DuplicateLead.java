...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='emailAddress']")).sendKeys("harshadkarthik@gmail.com");
		...
		driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-firstName']/a[text()='karthik']")).click();
